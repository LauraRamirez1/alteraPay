    ...
    //    }
       ...
       if (!$error) {
           ...
           $data = array(
               ...
               "reply_to" => $email,
               "sender_name" => $name,
               "html" => "De: ".$name."<br>"."Empresa: ".$empresa."<br>"."Cargo: ".$cargo."<br>"."Correo: ".$email."<br>"."Teléfono: ".$telefono."<br>",
               "text" => "De: ".$name."<br>"."Empresa: ".$empresa."<br>"."Cargo: ".$cargo."<br>"."Correo: ".$email."<br>"."Teléfono: ".$telefono."<br>",
               "subject" => 'Solicitud de Informacion - AlteraPay',
               "tag" => "Contacto-AlteraPay"
           );
